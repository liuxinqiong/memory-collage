				...
				<div class="wd665 dw01">
					<div class="blue_bian" style="overflow:hidden;">
						<div class="quest_tab">
							<ul>
								<li class="on">全部问答</li>
								<li class="current_none"><font color="#1bbf00">√ </font><a
									href="questionServlet?command=finished&key=${key }">已解决</a>
								</li>
								<li class="current_none"><font color="#ff6600">？</font><a
									href="questionServlet?command=unfinished&key=${key }">待解决</a>
								</li>
							</ul>
							<div class="clr"></div>
						</div>
								...
								<ul>
									<c:forEach items="${searchAskInfos}" var="searchAskInfo">
										<li>
											<h3>
												<a
													href="questionServlet?command=questionView&askId=${searchAskInfo.askNo}"
													target="_blank">${searchAskInfo.askTopic }</a>
											</h3>
