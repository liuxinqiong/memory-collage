				...
				<div class="quest_sort_tab">
					<ul>
						<li class="current_none"><a
							href="questionServlet?command=questionList&academyNo=${academy.academyNo }&professionNo=${profession.professionNo}">全部问题</a>
						</li>
						<li class="on"><font color="#ff6600">？</font>待解决</li>
						<li class="current_none"><a
							href="questionServlet?command=finishedQuestionList&academyNo=${academy.academyNo }&professionNo=${profession.professionNo}"><font
								color="#1bbf00">√ </font>已解决</a></li>
					</ul>
