						...
						<div>
							<div class="myAskTab" id="tab">
								<p style="font-size:16px; font-family: 'Microsoft YaHei'; ">
									&nbsp; &nbsp; &nbsp;
									<a href="questionServlet?command=myUnfinishedQuestion"> <font color="#FF0000" size="-1">待解决的提问</font> </a>&nbsp; 
									<a href="questionServlet?command=myFinishedQuestion"> <font color="#000000" size="-1">已解决的提问</font> </a>&nbsp; 
							...
							<div class="quest_sort_list">
								<table width="780" border="0" align="center">
									...
									<c:forEach items="${unfinishedAskInfos}" var="unfinishedAskInfo">
									<tr
										style="font-size:14px; font-family: 'Microsoft YaHei'; color:#1C1C1C"
										id="questionDetail">
										<td><a href="questionServlet?command=chooseAnswer&askNo=${unfinishedAskInfo.askNo}">${unfinishedAskInfo.askTopic}</a></td>
										<td>${unfinishedAskInfo.readerCount }</td>
										<td>未完结</td>
										<td>${unfinishedAskInfo.askDate }</td>
									</tr>
									</c:forEach>
								</table>
